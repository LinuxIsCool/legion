...
-- Workspace Assignments: 1=Terminal  2=Browser  3=Messaging  4=Media/Recording  5=Legion
-- (5 = Legion Hub, ruled in config/legion-hub.lua alongside its other window rules.)
hl.window_rule({ match = { class = "^(kitty)$" }, workspace = 1 })
hl.window_rule({ match = { class = "^(firefox|zen)$" }, workspace = 2 })
hl.window_rule({ match = { class = "^(TelegramDesktop|signal|Slack|zapzap|vesktop|discord)$" }, workspace = 3 })
